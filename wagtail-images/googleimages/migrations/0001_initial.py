    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_url', models.CharField(blank=True, editable=False, max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_url', models.CharField(blank=True, max_length=250)),
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='googleimages.googleimage')),
            ],
            options={
